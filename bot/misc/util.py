...
ru_language = {
    ...
    "edit_about": "🤖 Привет, я Учебный Помощник! Разработанный на хахатоне 2024 от МШП",
    "edit_description": "Описание, которое видит пользователь даже не нажав /start",
    "edit_commands": {"cmd": "cmd описание"},

    "start_msg": "👋 Привет! Я умный бот, и я момогу тебе в учёбе",
    ...
    "get_tags_time_over": "⏰ Введите время ДД.ММ.ГГ ММ:ЧЧ <code>14.04.24 19:20</code>",
    "get_tags_complexity": "🔢 Введите сложность от 1 до 10",
